...
export function checkEmailVerificationConfig() {
  ...
  const isCustomDomain =
    config.authDomain !== auth.app.options.projectId + ".firebaseapp.com";
  ...
  return {
    ...
    recommendations: {
      ...
      whitelisting:
        "Ensure your email service provider whitelists emails from firebase.com",
      spamFilters:
        "Ask users to check spam folders if they don't receive verification emails",
    },
  };
}
