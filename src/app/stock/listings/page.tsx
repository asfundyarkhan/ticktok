      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="flex border-b border-gray-200 mb-4 sm:mb-6 overflow-x-auto scrollbar-hide">
          <div className="flex min-w-max space-x-1 sm:space-x-0">
            ...
            <Link href="/stock/listings" className="px-2 sm:px-4 py-2 text-[#FF0059] border-b-2 border-[#FF0059] font-medium -mb-[2px] whitespace-nowrap text-xs sm:text-base flex-shrink-0">
              My Listings
            </Link>
        ...
        </div>        {/* Mobile-optimized Search Bar */}
