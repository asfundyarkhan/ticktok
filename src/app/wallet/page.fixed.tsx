          ...
          <div className="bg-white p-6 rounded-md shadow-sm">
            <div className="mb-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-900">
                  <span className="font-semibold">Account Name:</span> [Full Name]
                </p>
                <p className="text-sm text-gray-900">
                  <span className="font-semibold">Account Number:</span> [Bank Account Number]
                </p>
                <p className="text-sm text-gray-900">
                  <span className="font-semibold">Transfer Amount:</span> [Minimum $50]
                </p>
              </div>
            </div>
