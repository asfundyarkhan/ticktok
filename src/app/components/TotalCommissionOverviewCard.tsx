    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <div className="space-y-4">
            {/* Total Balance */}
            <div>
              <p className="text-sm text-gray-500">Total Commission Earned by All Admins</p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
              <div className="bg-blue-50 p-3 rounded-lg">
                <p className="text-xs text-blue-600 font-medium">Superadmin Deposits</p>
                <p className="text-lg font-bold text-blue-700">
                  ${commissionData.totalFromSuperadminDeposits.toFixed(2)}
                </p>
              </div>
              <div className="bg-purple-50 p-3 rounded-lg">
                <p className="text-xs text-purple-600 font-medium">Receipt Approvals</p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
              ...
              <div>
                <p className="text-sm text-gray-500">Average per Admin</p>
                <p className="text-xl font-semibold text-gray-900">
      ...
      <div className="mt-4 p-3 bg-gray-50 rounded-lg">
        <p className="text-xs text-gray-600">
          <strong>Note:</strong> This commission balance only includes earnings from superadmin deposits 
          and receipt approvals. Product sales revenue is not included in commission calculations.
        </p>
      </div>
    </div>
  );
