    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex border-b border-gray-200 mb-4 sm:mb-6 overflow-x-auto">
          <Link
            href="/profile"
            className="px-3 sm:px-4 py-2 text-gray-800 hover:text-gray-900 font-medium whitespace-nowrap text-sm sm:text-base"
          >
            General
          </Link>
          <Link
          ...
          <Link
            href="/withdrawals"
            className="px-3 sm:px-4 py-2 text-[#FF0059] border-b-2 border-[#FF0059] font-medium -mb-[2px] whitespace-nowrap text-sm sm:text-base"
          >
            Withdrawals
          </Link>
          <Link
