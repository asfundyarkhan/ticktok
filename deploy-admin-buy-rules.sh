...
echo -e "\033[0;32mDeploying Firestore rules for admin and superadmin dashboard buy permissions...\033[0m"
...
echo -e "\033[0;32mAdmins and superadmins can now buy seller products from the dashboard buy page.\033[0m"
