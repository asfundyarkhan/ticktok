...
Write-Host "Deploying Firestore rules for admin and superadmin purchase permissions..." -ForegroundColor Green
...
Write-Host "Admins and superadmins can now buy seller products." -ForegroundColor Green
