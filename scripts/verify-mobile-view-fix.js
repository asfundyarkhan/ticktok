...
filesToCheck.forEach(file => {
  ...
  if (fs.existsSync(filePath)) {
    ...
    const hasMobileClasses = content.includes('lg:hidden') || content.includes('hidden lg:');
    const hasResponsiveLayout = content.includes('flex-wrap') || content.includes('sm:flex-row');
