...
(function() {
  ...
  console.log('%c Admin Redirect Verification Tool ', 'background: #2563EB; color: white; padding: 5px; border-radius: 3px;');
  console.log('---------------------------------------');
  ...
  if (currentPath === '/dashboard/admin') {
    console.log('%c ✓ SUCCESS: Already on admin dashboard ', 'background: #10B981; color: white; padding: 3px; border-radius: 3px;');
    return;
  }
  ...
  setTimeout(() => {
    ...
    const testRedirectUrl = `/login?redirect=${encodeURIComponent('/dashboard/admin')}`;
