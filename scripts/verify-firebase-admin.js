...
console.log('FIREBASE_ADMIN_PROJECT_ID:', adminEnvVars.projectId ? '✅ Found' : '❌ Missing');
console.log('FIREBASE_ADMIN_CLIENT_EMAIL:', adminEnvVars.clientEmail ? '✅ Found' : '❌ Missing');
console.log('FIREBASE_ADMIN_PRIVATE_KEY:', adminEnvVars.privateKey ? '✅ Found' : '❌ Missing');
